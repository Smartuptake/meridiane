/* Nierenmeridian – Fuß-Shaoyin – 足少阴肾经
   ...
   vermessen: Spitze des Innenknöchels y 1042 (nicht 998 – das ist nur die
   schmalste Stelle des Knöchels), Condylus medialis der Tibia y 840,
   dazwischen 13 Cun, also 15,5 Bildpunkte je Cun am Unterschenkel.
   Am Rumpf: Mittellinie x 437, Nabel y 436, Brustbeinwinkel y 354,
...
Meridian.register({
  ...
  cun: { knoechel: [392, 1042], knie: [397, 840],
         hinweis: "Spitze des Innenknöchels → Condylus medialis der Tibia = 13 Cun; Ni 7 liegt 2 Cun über Ni 3" },

  path: [[355,1098],[372,1088],[385,1080],[394,1074],
         [381,1072],[371,1058],[368,1040],[372,1024],[380,1016],
         [390,1038],[392,1050],[391,1062],[380,1062],
  ...
  points: [
    { n:1, pinyin:"Yǒngquán", han:"涌泉", de:"Sprudelnde Quelle", en:"Gushing Spring",
      ...
      wirkung:["Ting / Jing – Brunnen-/Quellpunkt", "Holzpunkt der Nieren-Leitbahn", "Sedierungspunkt", "", "Senkt aufsteigendes Yang ab und holt es nach unten", "Klärt Hitze und beruhigt den Geist", "Belebt bei Bewusstlosigkeit", "Der erdende Punkt schlechthin"],
      marken:["mfk23"],
    ...
    { n:2, pinyin:"Rángǔ", han:"然谷", de:"Loderndes Tal", en:"Blazing Valley",
      x:394, y:1074, key:false, role:"YONG",
      antik:"yong", wx:"feuer",
    ...
    { n:3, pinyin:"Tàixī", han:"太溪", de:"Großer Gebirgsbach", en:"Great Ravine",
      x:390, y:1038, key:true, role:"YU · YUAN",
      antik:"yu", wx:"erde",
      tags:["Yu / Shu – Bachpunkt","Yuan-Quellpunkt","der Hauptpunkt der Niere"],
      wirkung:["Yu / Shu – Bachpunkt", "Erdpunkt der Nieren-Leitbahn", "Yuan-Quellpunkt", "", "Stärkt die Niere – Yin und Yang zugleich", "Festigt die Essenz", "Nährt das Mark und stärkt Knochen und Lenden", "Fasst das Qi zum Einatmen"],
      marken:["innenknoechel", "achillessehne"],
    ...
    { n:4, pinyin:"Dàzhōng", han:"大钟", de:"Große Glocke", en:"Large Goblet",
      x:392, y:1050, key:true, role:"LUO",
      antik:"luo", wx:"",
      tags:["Luo-Punkt zur Blase"],
      wirkung:["Luo-Punkt – zieht zur Blase", "", "Stärkt den Willen und vertreibt Angst", "Fasst das Qi und lindert Kurzatmigkeit", "Ordnet das Wasserlassen"],
      marken:["achillessehne", "ferse"],
    ...
    { n:5, pinyin:"Shuǐquán", han:"水泉", de:"Wasserquelle", en:"Water Spring",
      x:391, y:1062, key:false, role:"XI",
      antik:"xi", wx:"",
      tags:["Xi-Spaltpunkt"],
      wirkung:["Xi-Cleft – Akkumulationspunkt", "", "Akutpunkt bei Schmerz in der Regel", "Bewegt das Blut im Unterbauch", "Ordnet das Wasserlassen"],
      marken:["innenknoechel", "ferse"],
    ...
    { n:6, pinyin:"Zhàohǎi", han:"照海", de:"Leuchtendes Meer", en:"Shining Sea",
      x:380, y:1062, key:true, role:"",
      antik:"", wx:"",
      tags:["Öffnungspunkt des Yinqiao Mai","Paarpunkt zu Lu 7","einer der Acht Kreuzungspunkte"],
      wirkung:["Öffnungspunkt des Yinqiao Mai", "Paarpunkt zu Lu 7", "Einer der Acht Kreuzungspunkte", "", "Nährt das Yin und kühlt Leerhitze", "Befeuchtet die Kehle", "Beruhigt den Geist und bringt Schlaf", "Ordnet die Regel"],
      marken:["innenknoechel"],
    ...
    { n:7, pinyin:"Fùliū", han:"复溜", de:"Wiederkehrender Strom", en:"Recover Flow",
      x:386, y:1011, key:true, role:"KING · TON",
      antik:"king", wx:"metall",
      tags:["King / Jing – Flusspunkt","Tonisierungspunkt","Hauptpunkt beim Schwitzen"],
      wirkung:["King / Jing – Strom-/Flusspunkt", "Metallpunkt der Nieren-Leitbahn", "Tonisierungspunkt", "", "Regelt das Schwitzen – gegen Nachtschweiß wie gegen fehlenden Schweiß", "Stärkt das Nieren-Yang", "Leitet Wasser aus und löst Ödeme"],
      marken:["innenknoechel", "achillessehne"],
    ...
    { n:9, pinyin:"Zhùbīn", han:"筑宾", de:"Haus des Gastes", en:"Guest House",
      x:388, y:965, key:false, role:"",
      antik:"", wx:"",
      tags:["Xi-Spaltpunkt des Yinwei Mai","Entgiftungspunkt"],
      wirkung:["Xi-Spaltpunkt des Yinwei Mai", "", "Klärt Hitze und leitet Giftiges aus", "Beruhigt den Geist", "Löst Krämpfe in der Wade"],
      marken:["tibia_hinten"],
    ...
    { n:10, pinyin:"Yīngǔ", han:"阴谷", de:"Yin-Tal", en:"Yin Valley",
      x:397, y:820, key:true, role:"HO",
      antik:"ho", wx:"wasser",
      tags:["Ho / He – Meerpunkt","eigener Wasserpunkt des Wassermeridians"],
      wirkung:["Ho / He – Meerpunkt", "Wasserpunkt der Nieren-Leitbahn", "", "Nährt das Nieren-Yin", "Ordnet den Genitalbereich und die Regel", "Löst Feuchtigkeit im Unteren Erwärmer"],
      marken:["condylus_med"],
    ...
    { n:16, pinyin:"Huāngshū", han:"肓俞", de:"Zustimmungspunkt der Zwischenräume", en:"Huang Shu",
      x:429, y:436, key:true, role:"",
      antik:"", wx:"",
      tags:["auf Nabelhöhe","Kreuzungspunkt mit dem Chong Mai"],
      wirkung:["Auf Nabelhöhe", "Kreuzungspunkt mit dem Chong Mai", "", "Ordnet den Darm bei Verstopfung wie bei Durchfall", "Löst Schmerz um den Nabel", "Bewegt das Qi in der Mitte"],
      marken:["nabel", "mittellinie"],
    ...
    { n:21, pinyin:"Yōumén", han:"幽门", de:"Dunkles Tor", en:"Dark Gate",
      x:429, y:374, key:false, role:"",
      antik:"", wx:"",
      tags:["Ende der Bauchlinie","Kreuzungspunkt mit dem Chong Mai"],
      wirkung:["Ende der Bauchlinie", "Kreuzungspunkt mit dem Chong Mai", "", "Senkt gegenläufiges Magen-Qi ab", "Löst Erbrechen und Aufstoßen", "Harmonisiert die Mitte"],
      marken:["brustbeinwinkel", "mittellinie"],
    ...
    { n:22, pinyin:"Bùláng", han:"步廊", de:"Wandelgang", en:"Corridor Walk",
      ...
      wirkung:["Beginn der Brustlinie", "", "Öffnet die Brust und stillt Husten", "Senkt gegenläufiges Qi ab", "Löst Enge zwischen den Rippen"],
      marken:["brustwarze"],
    ...
    { n:23, pinyin:"Shénfēng", han:"神封", de:"Siegel des Geistes", en:"Spirit Seal",
      ...
      wirkung:["Auf Brustwarzenhöhe", "", "Öffnet die Brust und beruhigt den Geist", "Stillt Husten und Kurzatmigkeit", "Löst Enge und Druck auf der Brust"],
      marken:["brustwarze"],
    ...
    { n:25, pinyin:"Shéncáng", han:"神藏", de:"Speicher des Geistes", en:"Spirit Storehouse",
      ...
      antik:"", wx:"",
      tags:["Brustlinie"],
      wirkung:["Brustlinie", "", "Öffnet die Brust und stillt Husten", "Beruhigt den Geist", "Senkt gegenläufiges Qi ab"],
      marken:["brustwarze"],
    ...
    { n:27, pinyin:"Shùfǔ", han:"俞府", de:"Palast der Zustimmung", en:"Shu Mansion",
      ...
      wirkung:["Endpunkt der Nieren-Leitbahn", "", "Stillt Husten und Kurzatmigkeit", "Senkt gegenläufiges Qi ab", "Öffnet die Brust unter dem Schlüsselbein"],
