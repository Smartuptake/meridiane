...
window.MeridianKatalog = [
  ...
  { umlauf:1, id:"li", titel:"Dickdarmmeridian", code:"LI", codeDe:"Di", name:"Dickdarm",     han:"大腸", channel:"Hand-Yangming", element:"Metall", wx:"metall", yin:false, clock:"05–07", points:20, view:"front", fertig:false },
  ...
  { umlauf:2, id:"ht", titel:"Herzmeridian", code:"HT", codeDe:"He", name:"Herz",         han:"心", channel:"Hand-Shaoyin",  element:"Feuer",  wx:"feuer",  yin:true,  clock:"11–13", points:9,  view:"front", fertig:false },
  { umlauf:2, id:"si", titel:"Dünndarmmeridian", code:"SI", codeDe:"Dü", name:"Dünndarm",     han:"小腸", channel:"Hand-Taiyang",  element:"Feuer",  wx:"feuer",  yin:false, clock:"13–15", points:19, view:"back",  fertig:false },
  ...
  { umlauf:2, id:"ki", titel:"Nierenmeridian", code:"KI", codeDe:"Ni", name:"Niere",        han:"腎", channel:"Fuß-Shaoyin",   element:"Wasser", wx:"wasser", yin:true,  clock:"17–19", points:27, view:"front", fertig:false },
  ...
  { umlauf:3, id:"te", titel:"Drei-Erwärmer-Meridian", code:"TE", codeDe:"3E", name:"Drei-Erwärmer",han:"三焦", channel:"Hand-Shaoyang", element:"Feuer",  wx:"feuer",  yin:false, clock:"21–23", points:23, view:"back",  fertig:false },
  { umlauf:3, id:"gb", titel:"Gallenblasenmeridian", code:"GB", codeDe:"Gb", name:"Gallenblase",  han:"膽", channel:"Fuß-Shaoyang",  element:"Holz",   wx:"holz",   yin:false, clock:"23–01", points:44, view:"side",  fertig:false },
