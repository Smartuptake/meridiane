...
Meridian.register({
  ...
  path: [[145,613],[154,593],[163,580],[170,558],[186,538],[200,521],[206,508],[212,494],
         [220,476],[230,452],[240,432],[248,414],[262,390],[278,362],[291,330],[300,296],
         [305,268],[312,248],[332,228],[362,212],[388,200],[406,186],[418,168],[428,152],
         [432,146],[440,142],[448,134]],
  ...
  points: [
    { n:1, pinyin:"Shāngyáng", han:"商阳", de:"Äußerstes Yang, Metall-Yang", en:"Shang Yang",
      x:145, y:613, key:true, role:"TING · BEN",
      antik:"ting", wx:"metall",
      tags:["Ting / Jing – Brunnen-/Quellpunkt","Ben-Punkt","Notfallpunkt"],
      wirkung:["Ting / Jing – Brunnen-/Quellpunkt", "Metallpunkt der Dickdarm-Leitbahn", "", "Beseitigt Hitze und Schwellung", "Befreit die Kehle", "Belebt bei Bewusstlosigkeit"],
      skelett:"handflaeche",
      marken:["zeigefinger_rad"],
    ...
    { n:2, pinyin:"Èrjiān", han:"二间", de:"Zweites Intervall", en:"Second Space",
      x:154, y:593, key:false, role:"YONG · SED",
      antik:"yong", wx:"wasser",
      tags:["Yong / Ying – kleiner Flusspunkt","Sedierungspunkt"],
      wirkung:["Yong / Ying – kleiner Flusspunkt", "Wasserpunkt der Dickdarm-Leitbahn", "", "Klärt Hitze aus Gesicht und Kehle", "Lindert Zahnschmerz", "Vertreibt Wind"],
      skelett:"handflaeche",
      marken:["zeigefinger_gg", "zeigefinger_rad"],
    ...
    { n:3, pinyin:"Sānjiān", han:"三间", de:"Drittes Intervall", en:"Third Space",
      x:163, y:580, key:false, role:"YU",
      antik:"yu", wx:"holz",
      tags:["Yu / Shu – größerer Flusspunkt"],
      wirkung:["Yu / Shu – Bachpunkt", "Holzpunkt der Dickdarm-Leitbahn", "", "Klärt Hitze", "Löst Schwellung in Kehle und Augen", "Öffnet die Leitbahn bei Schmerz in Hand und Finger"],
      skelett:"handflaeche",
      marken:["zeigefinger_gg"],
    ...
    { n:4, pinyin:"Hégǔ", han:"合谷", de:"Vereinte Täler", en:"Joining Valley",
      x:170, y:558, key:true, role:"YUAN",
      tags:["Yuan-Quellpunkt","Kommandopunkt Gesicht und Mund","einer der vier Tore"],
      wirkung:["Yuan-Quellpunkt", "eines der Vier Tore, mit Le 3", "Kommandopunkt für Gesicht und Mund", "", "Befreit die Oberfläche und vertreibt Wind", "Klärt Hitze", "Stillt Schmerz im ganzen Körper", "Reguliert Schweiß – treibt ihn aus oder hält ihn zurück", "In der Schwangerschaft verboten"],
      skelett:"handflaeche",
      marken:["mhk12"],
    ...
    { n:5, pinyin:"Yángxī", han:"阳溪", de:"Yang-Schlucht", en:"Yang Ravine",
      ...
      wirkung:["King / Jing – Flusspunkt", "Feuerpunkt der Dickdarm-Leitbahn", "", "Klärt Hitze aus Kehle, Zähnen und Ohr", "Beruhigt den Geist", "Löst das Handgelenk"],
      skelett:"handflaeche",
      marken:["daumensehnen", "griffel_speiche"],
    ...
    { n:6, pinyin:"Piānlì", han:"偏历", de:"Schräge Verbindung", en:"Veering Passage",
      x:212, y:494, key:true, role:"LUO",
      tags:["Luo-Punkt – Verbindungspunkt","zieht zum Yuan-Punkt Lu 9"],
      wirkung:["Luo-Punkt zur Lunge", "", "Öffnet die Wasserwege und wirkt bei Ödemen", "Befreit die Oberfläche", "Klärt Hitze aus Gesicht und Nase"],
      marken:["speiche_rand"],
    ...
    { n:7, pinyin:"Wēnliū", han:"温溜", de:"Warmer Strom", en:"Warm Dwelling",
      x:220, y:476, key:false, role:"XI",
      tags:["Xi-Cleft – Akkumulationspunkt","Akutpunkt"],
      wirkung:["Xi-Spaltpunkt", "", "Klärt Hitze bei Akutem", "Beruhigt Magen und Darm", "Löst Schwellung in Gesicht und Kehle"],
      marken:["speiche_rand"],
    ...
    { n:10, pinyin:"Shǒusānlǐ", han:"手三里", de:"Dritter Weiler an der Hand", en:"Arm Three Li",
      ...
      wirkung:["Erdpunkt-Charakter in der Wirkung, kein Antikpunkt", "", "Stärkt Qi und Blut", "Reguliert Magen und Darm", "Der Hauptpunkt bei Tennisellenbogen"],
      marken:["ellenbeuge"],
    ...
    { n:11, pinyin:"Qūchí", han:"曲池", de:"Gekrümmter Teich", en:"Pool at the Bend",
      ...
      wirkung:["Ho / He – Meerpunkt", "Erdpunkt der Dickdarm-Leitbahn", "Sedierungspunkt", "", "Klärt Hitze – der wichtigste Punkt bei Fieber", "Kühlt Blut und stillt Juckreiz", "Reguliert Qi und Blut", "Löst den Ellenbogen"],
      marken:["ellenbeuge", "epicond_lat"],
    ...
    { n:15, pinyin:"Jiānyú", han:"肩髃", de:"Schulterecke", en:"Shoulder Bone",
      ...
      wirkung:["Treffpunkt mit dem Yangqiao Mai", "", "Öffnet die Schulter und löst Bewegungssperre", "Vertreibt Wind und Feuchtigkeit aus der Leitbahn"],
    ...
    { n:20, pinyin:"Yíngxiāng", han:"迎香", de:"Den Duft empfangen", en:"Welcome Fragrance",
      x:448, y:134, key:true, role:"",
      tags:["Endpunkt des Meridians","Treffpunkt mit dem Magen-Meridian"],
      wirkung:["Endpunkt der Leitbahn", "Treffpunkt mit dem Magenmeridian", "", "Öffnet die Nase – der Hauptpunkt bei jeder verstopften Nase", "Vertreibt Wind und klärt Hitze", "Löst Gesichtslähmung"],
      marken:["nasenfluegel"],
