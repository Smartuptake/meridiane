...
window.Himmelskreislauf = {
  ...
  erlaeuterungen: [
    ...
    { titel:"02 und 11  Drüse ist nicht Oberflächenpunkt",
      text:"Die Hypophyse (腦垂體 / 脑垂体; nǎo chuí tǐ | Naochuiti; Pituitary Gland) liegt nicht zwischen den Augenbrauen. Yintang ist der ergänzte äußere Bezug des Stirnzentrums. Auch die Zirbeldrüse liegt nicht an der Kopfhaut. Die Grafik zeigt ihre Scheitelzuordnung, keinen zusätzlichen Akupunkturpunkt." },
    { titel:"04  Hsuan Chi ist mehrdeutig",
      text:"Als ältere Umschrift entspricht „Hsuan Chi“ dem Namen Xuanji (璇璣 / 璇玑; xuán jī | Xuanji; Jade Pivot; Jadedrehpunkt; KG21 / CV21). Die chinesisch beschriftete Vergleichsgrafik ordnet das Halszentrum jedoch Tiantu (天突; tiān tū; KG22 / CV22) zu. Deshalb zeigt die Übersicht Tiantu mit Sternchen. KG21 liegt weiter unten am oberen Brustbein; beide Punkte sind nicht identisch. [1, 2]" },
    ...
    { titel:"07 und 15  Zweimal Chi-Chung",
      text:"Am Nabel meint die Vorlage die Nabelmitte, auch Qizhong (臍中 / 脐中; qí zhōng | Qizhong; Navel Centre), mit dem Standardpunkt Shenque KG8 / CV8. Am Rücken bezeichnet „Chi-Chung“ Jizhong (脊中; jǐ zhōng), LG6 / GV6, unter dem elften Brustwirbel. Trotz ähnlicher alter Schreibweise sind es zwei verschiedene Orte. [1, 2]" },
    { titel:"08  Samen- und Eierstockpalast",
      text:"Die Vorlage benennt ein Sexualzentrum, keinen eindeutig nummerierten Oberflächenpunkt. Jinggong (精宮 / 精宫) bezeichnet den Samen- bzw. Essenzpalast; es ist nicht automatisch ein gemeinsamer Akupunkturpunkt für beide Geschlechter. Deshalb wurde hier keine KG-Nummer ergänzt." },
